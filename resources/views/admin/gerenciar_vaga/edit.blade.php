...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <form action="{{ route('admin.vaga.update') }}" method="POST">
                @csrf
                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="input-group input-group-sm mb-4">
                                    ...
                                    <input type="date" class="form-control" value="{{ date('Y-m-d', strtotime($edit->data_abertura)) }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="input-group input-group-sm mb-4">
                                    ...
                                    <input type="date" class="form-control" value="{{ date('Y-m-d', strtotime($edit->data_vencimento)) }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group input-group-sm mb-4">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.vaga.listar') }}" class="btn btn-danger btn-sm"><i class="fas fa-arrow-left"></i> Voltar</a>
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    $("#estado").change(function() {
        if ($("#estado").val() != '') {
            $.ajax({
                type: 'get',
                url: '/admin/empresa/vaga/getEstado/' + $("#estado").val(),
                beforeSend: function() {
