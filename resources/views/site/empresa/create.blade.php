...
<div class="container" style="margin:0 auto;">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <form action="{{ route('site.cadastro.create') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('site.home') }}" class="btn btn-danger btn-sm"><i class="fas fa-arrow-left"></i> Cancelar</a>
                    </div>
                </div>
            </form>
        </div>
