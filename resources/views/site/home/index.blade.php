            ...
            <article class="blog-post">
                <section class="blog-post__header">
                    <div class="blog-post__image">
                        @if(!empty($post->capa))
                        <img src="{{ asset($post->capa) }}" width="160" height="160" alt="{{ $post->capa ?? null }}" style="border-radius:100%;" />
                        @else
                        <img src="{{ asset('site/assets/images/profile-image.png') }}" width="130" height="130" alt="{{ $post->capa ?? null }}" style="border-radius:100%;" />
                        @endif
                    </div>
                    <div class="blog-post__description">
                        ...
                        <a href="{{ route('site.blog.show', $post->slug) }}" class="blog-post__read-more">Leia Mais...</a>
                    </div>
                </section>
