    ...
    <main id="container">
        <div class="wrapper container-fluid">
            <header class="site-header">
                <div class="logo">
                    <a href="#"><img src="{{ asset('site/img/logo.png') }}" alt="Busca PCD Empregos - Logo" /></a>
                </div>
                <nav class="secondary-nav">
                    <ul>
                        ...
                        <li>
                            ...
                            @else
                            <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="{{ route('empresa.sair') }}" class="login"><i class="fas fa-user-circle"></i>&nbsp;Sair</a>
                            <form id="logout-form" action="{{ route('empresa.sair') }}" method="POST" style="display: none;">
                                @csrf
                            </form>
                            @endif
                        </li>
        ...
        -->
                <ul id="menu">
                    ...
                    <a href="#" class="highlight" target="_blank">
                        <li>Cadastrar CV</li>
                    </a>
        ...
        <nav class="main-menu hide show-md">
            <ul>
                <li><a href="#">Sobre o Busca PCD</a></li>
